...
#define REVIS_VERSION_SAT22F    12
#define REVIS_VERSION_SATNRD    7
#define REVIS_VERSION_HUB22F    13
#define REVIS_VERSION_HUBNRD    8
...
#define MAX_SENSORS_IN_CS		7 /* Maximum sensors that can be connected to sat 22f */
#define MAX_SPI_CS				  7 /* Chip select runs 0 to 6 */
