 ...
 * Definitions
 ******************************************************************************/
#define SAT_ID			231 /* TODO later will read from memory region */
...
dspi_status_t talk_to_nordic() {
	...
	/* Do nothing since it will get overwritten anyways. */


	dataToSend.data.sat_id = 0xdeadbeef;
	dataToSend.data.timestamp = 0x12345678;
	dataToSend.data.data.quat_w = 0.1;
	dataToSend.data.data.quat_x = 0.2;
	dataToSend.data.data.quat_y = 0.3;
	dataToSend.data.data.quat_z = 0.4;
