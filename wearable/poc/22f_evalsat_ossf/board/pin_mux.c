...
//      /* PORTC_PCR4 */
//      PORT_HAL_SetMuxMode(g_portBaseAddr[2],4u,kPortMuxAsGpio);  used by SPI0 Nordic
//      /* PORTC_PCR7 */
//      PORT_HAL_SetMuxMode(g_portBaseAddr[2],7u,kPortMuxAsGpio);  used by SPI0 Nordic
      /* PORTC_PCR11 */
...
//      /* PORTD_PCR4 */
//      PORT_HAL_SetMuxMode(g_portBaseAddr[3],4u,kPortMuxAsGpio);  used by SPI1 Invensense
//      /* PORTD_PCR5 */
//      PORT_HAL_SetMuxMode(g_portBaseAddr[3],5u,kPortMuxAsGpio);  used by SPI1 Invensense
      break;
    case 4:                             /* PTE */
      /* PORTE_PCR0 */
...
{
  PORT_HAL_SetMuxMode(g_portBaseAddr[2],4u,kPortMuxAsGpio);  // PTC4 = SPI0_nCS0 for Nordic nRF51822
}

void pin_mux_SPI_CS1(uint32_t instance)
{
  PORT_HAL_SetMuxMode(g_portBaseAddr[3],4u,kPortMuxAsGpio);  // PTD4 = SPI1_nCS0 for Invensense MPU9250
}
*/
