...
class Screen (object):
    def __init__(self,x=320,y=280,scale=1,origin_offset=(0,0)):
        self.i = pygame.display.set_mode((x,y))
        self.originx = (self.i.get_width() / 2) + origin_offset[0]
        self.originy = (self.i.get_height() / 2) + origin_offset[1]
        self.scale = scale
