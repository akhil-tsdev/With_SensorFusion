...
#define BSPCFG_ENABLE_SPI_STATS					 1 //cwati enable SPI stats
...
#define BSPCFG_ENABLE_SPI0                        0 /* cw todo for sensor */
...
/* Turingsense disable SERIAL for this board, it's conflicting with a lot
 * of our pins.
 */
#if TURINGSENSE
#define TS_BSPCFG_ENABLE_SERIAL					  0
#endif
...
//TONY
#define BSPCFG_ENABLE_TTYB                        0 /* cwati this conflicts with PTD 9*/
...
#define BSPCFG_ENABLE_TTYF                        0 /* cwati this conflicts with PTD 9*/
