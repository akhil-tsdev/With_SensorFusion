...
*/
#if PRODUCTION1
#define BSP_LED1                    (GPIO_PORT_A | GPIO_PIN10) /* RED LED */
#define BSP_LED2                    (GPIO_PORT_A | GPIO_PIN11) /* GREEN LED */
#define BSP_LED3                    (GPIO_PORT_A | GPIO_PIN12) /* BLUE LED */
...
#define BSP_ENET0_PHY_MII_SPEED             (2500000L)
    ...
    #define BSPCFG_RX_RING_LEN              0 /* Number of receive BD's */
#endif

#ifndef BSPCFG_TX_RING_LEN
    #define BSPCFG_TX_RING_LEN              0 /* Number of transmit BD's */
#endif
...
#define BSP_ATHEROS_WIFI_SPI_DEVICE                 "spi2:0"
#endif
