...
)
{
    ...
    {
#ifndef TURINGSENSE
#error TURINGSENSE needs to be defined!
#endif
        ...
        case 0:
            ...
            pctl->PCR[5] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;     /* DSPI0.SCK    */
            pctl->PCR[6] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;     /* DSPI0.SOUT   */
            pctl->PCR[7] = PORT_PCR_MUX(2) | PORT_PCR_DSE_MASK;     /* DSPI0.SIN    */
