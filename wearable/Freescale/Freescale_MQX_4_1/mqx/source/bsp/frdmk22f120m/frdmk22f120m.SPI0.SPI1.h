...
/* SPI0 FIFO size = 4 */
/* SPI1 FIFO size = 1 */
#define DSPI_FIFO_DEPTH                  (4)	//cwati try use 4 for both SPI0 and SPI1 enabled
...
*/
#ifdef ATH_SPI_DMA    
#define BSP_ATHEROS_WIFI_SPI_DEVICE                 "dspi1:"    
#else
///e.y. change for K22D sp140
#define BSP_ATHEROS_WIFI_SPI_DEVICE                 "spi1:"
#endif
#define BSP_ATHEROS_WIFI_GPIO_INT_DEVICE                "gpio:input"
#define BSP_ATHEROS_WIFI_GPIO_INT_PIN                   (GPIO_PORT_C|GPIO_PIN_IRQ_FALLING|GPIO_PIN6)

#define BSP_ATHEROS_WIFI_GPIO_PWD_DEVICE                "gpio:write"
#define BSP_ATHEROS_WIFI_GPIO_PWD_PIN                   (GPIO_PORT_B|GPIO_PIN19) //TONY
#define BSP_ATHEROS_WIFI_GPIO_FET_PIN                   (GPIO_PORT_B|GPIO_PIN19)
