/*
 $License:
    ...
    Modified by Embedded Masters for use with Freescale Kinetis K22
 $
 */
/*******************************************************************************
 * $Id: $
...
/**
 *  @defgroup K22_System_Layer K22 System Layer
 *  @brief  K22 System Layer APIs.
 *          To interface with any platform, eMPL needs access to various
 *          system layer functions.
 *
 *  @{
 *      @file   log_k22.c
 *      @brief  Logging facility for the Freescale Kinetis K22.
 */
