...
#define TS_SENDING_FREQ			50	/* Hz.  If PACE_SENSOR_OUTPUT is enabled, we will only send this fast even though TS_GYRO_FREQ
								     * is faster. */
#define TS_SENDING_PERIOD		(TS_GYRO_FREQ / TS_SENDING_FREQ) /* Say this value is 2, ie TS_GYRO_FREQ is 200 Hz and SENDING_FREQ is 100 Hz,
															   * that means we will only send 1 for every 2 sensor data generated. */
