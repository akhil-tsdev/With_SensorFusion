...
//			}
//
			cmdIndex = 1; //cwati receiver
			switch (cmdIndex) {
				case 1:
					//reinit_esb();
					net_init32(process_packet_uint32, nack_warning, 48, 51, RADIO_TXPOWER_TXPOWER_Pos4dBm,
...
//				}
				...
				case 2:
					...
					//reinit_esb();
					net_init32(process_packet_uint32, nack_warning, g_ts_radio_dtm_tx_channel_id, g_ts_radio_dtm_rx_channel_id, g_ts_radio_dtm_power_level,
						g_ts_radio_dtm_tx_package_type, 4, g_ts_radio_dtm_rx_package_type, 4);
					uesb_start_tx();
