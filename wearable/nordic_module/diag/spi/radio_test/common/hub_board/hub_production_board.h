 ...
 *
 * hub_production_board.h
 *
 * Custom board for hub production.
 *
 */
 
 #ifndef __HUB_PRODUCTION_BOARD_H__
 #define __HUB_PRODUCTION_BOARD_H__
 
 #include "hub_spi_types.h"
...
#define SPIS_MISO_PIN  TS_SPI_MISO_PIN    // SPI MISO signal. 
#define SPIS_CSN_PIN   TS_SPI_SS_PIN    	// SPI CSN signal. 
#define SPIS_MOSI_PIN  TS_SPI_MOSI_PIN    // SPI MOSI signal. 
#define SPIS_SCK_PIN   TS_SPI_CLK_PIN    	// SPI SCK signal. 
...
#endif /* __HUB_PRODUCTION_BOARD_H__ */
