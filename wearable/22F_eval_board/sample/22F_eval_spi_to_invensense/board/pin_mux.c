...
{
  switch(instance) {
	case 0:                             /* SPI0 for Invensense Sensor */
	  /* PORTD_PCR1 SCK */
...
//      break;
    case 1:                             /* SPI1 for Nordic nRF51-DK */
      /* PORTD_PCR4 */
      ...
      /* PORTB_19 - re-route SP1_CS */
      PORT_HAL_SetMuxMode(g_portBaseAddr[1],19u,kPortMuxAsGpio);
//      /* PORTE_0 (PTE0) as SPI1_PCS1 */
//      PORT_HAL_SetMuxMode(g_portBaseAddr[4],0u,kPortMuxAlt2);
      break;
    default:
      break;
  }
