...
#endif /* CWATI */
//uint8_t cwatiSend[256];
//uint8_t cwatiRecv[256];



int cwati() {
	printf("CWATI: I AM IN THE LIBRARY, PRAISE GOD!\n");
}
...
//    uint32_t val;
//    MPU9250_SPI_TXBUF = data;
////		spi_rx_ready_flag=0;
////		while ((spi_rx_ready_flag==0));
////
//    val = MPU9250_SPI_RXBUF; /* Read values */
//    return val;
