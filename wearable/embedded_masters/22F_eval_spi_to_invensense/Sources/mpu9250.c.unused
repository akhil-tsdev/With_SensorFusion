...
#define mpu9250_spi_WriteReg test_mpu9250WriteReg
#define mpu9250_spi_send cwati_spi_send

uint32_t  mpu9250_spi_ReadReg( uint8_t WriteAddr, uint8_t WriteData )
{
    return test_mpu9250WriteReg( WriteAddr | MPU9250_READ_FLAG, WriteData);
}
